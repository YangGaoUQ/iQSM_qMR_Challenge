function Recon_iQFM(PhasePath, paramspath, MaskPath, MagPath, ReconDir)
%% iQFM reconstruction for data from ChinaJapan hospital
...
% NetType = 1;   % network type, 0 for iQSM, 1 for iQSM_plus;
...
KeyWord = 'iQFM_original'; % for iQFM (local field) recon; 
...
save_nii(nii, [ReconDir, filesep, 'iQFM_all_echoes.nii']);
